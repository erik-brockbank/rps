...
const INSTRUCTION_ARRAY = [
    ...
    {
        top_text: "<p>1. In each round, you will select one of the rock, paper, or scissors " +
    ...
    {
        top_text: "<p>2. Your opponent is going to choose a card to play as well, but neither of " +
            "you can see what the other has selected until after you have both chosen.</p>",
        canvas_img: "",
        bottom_text: ""
    },
    {
        top_text: "<p>3. Once both you and your opponent have selected a card to play in the " +
    ...
    },
    {
        top_text: "<p>In each round, the rules for which card wins are simple:</p>" +
            "<p>- Rock beats scissors (to remember, imagine the rock breaking the scissors).</p>" +
            "<p>- Scissors beats paper (to remember, imagine the scissors cutting the paper).</p>" +
            "<p>- Paper beats rock (to remember, imagine the paper wrapping around the rock).</p>" +
