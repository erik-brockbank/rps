...
const ROUND_TIMEOUT = 3000; // number of seconds for players to make a decision each round (includes some buffer for loading)
...
const INSTRUCTION_ARRAY = [
    ...
    },
    {
        ...
        canvas_img: "rock-paper-scissors-individ.jpg",
        bottom_text: ""
    },
    {
    ...
    },
    {
        top_text: "<p>In each round, the rules for which card wins are simple:</p>" +
            ...
            "<p>4. If both players play the same card, the round is a tie.</p>",
        canvas_img: "",
        bottom_text: ""
    },
    {
