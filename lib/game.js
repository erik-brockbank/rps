...
rps_round = function(game) {
    this.game_id = game.game_id; // numeric: unique id for the game this round belongs to
    ...
    this.player1_id = game.player1.client_id; // numeric: unique id for player 1 in this round
    this.player2_id = game.player2.client_id; // numeric: unique id for player 2 in this round
...
rps_player = function(client) {
    this.client_id = client.userid; // numeric: id for this client
