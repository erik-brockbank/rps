...
const ADAPTIVE_BOT_STRATEGY_SET = [ // set of available adaptive strategies
    ...
    // Transition marginal
    // "opponent_prev_transition", // maximize against the opponent's transition distribution (relative to their own move)
    // "opponent_prev_courn_transition", // maximize against the opponent's transition distribution (relative to the bot's move)
