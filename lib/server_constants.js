...
const GAME_ROUNDS = 20; // number of rounds opponents play in each game
...
const ONE_BACK_MOVE_COUNTER = {
    "rock": Object.assign({}, BASE_MOVE_COUNTER),
    "paper": Object.assign({}, BASE_MOVE_COUNTER),
    "scissors": Object.assign({}, BASE_MOVE_COUNTER)
};

const TWO_BACK_MOVE_COUNTER = {
    "rock": Object.assign({}, ONE_BACK_MOVE_COUNTER),
    "paper": Object.assign({}, ONE_BACK_MOVE_COUNTER),
    "scissors": Object.assign({}, ONE_BACK_MOVE_COUNTER)
};
...
const OUTCOME_TRANSITION_COUNTER = {
    "win": Object.assign({}, BASE_TRANSITION_COUNTER),
    "loss": Object.assign({}, BASE_TRANSITION_COUNTER),
    "tie": Object.assign({}, BASE_TRANSITION_COUNTER)
};

// Memory lookup constructed from counter structures above
const ADAPATIVE_BOT_MEMORY_LOOKUP = {
    "opponent_moves": Object.assign({}, BASE_MOVE_COUNTER),
    "opponent_prev_move": Object.assign({}, ONE_BACK_MOVE_COUNTER),
    "bot_prev_move": Object.assign({}, ONE_BACK_MOVE_COUNTER),
    "opponent_bot_prev_move": JSON.parse(JSON.stringify(TWO_BACK_MOVE_COUNTER)),
    "opponent_prev_two_moves": JSON.parse(JSON.stringify(TWO_BACK_MOVE_COUNTER)),
    "bot_prev_two_moves": JSON.parse(JSON.stringify(TWO_BACK_MOVE_COUNTER)),
    "opponent_transitions": Object.assign({}, BASE_TRANSITION_COUNTER),
    "opponent_courn_transitions": Object.assign({}, BASE_TRANSITION_COUNTER),
    "opponent_outcome_transitions": Object.assign({}, OUTCOME_TRANSITION_COUNTER),
    "opponent_outcome_prev_transition_dual": {"+": JSON.parse(JSON.stringify(OUTCOME_TRANSITION_COUNTER)),
                                                "-": JSON.parse(JSON.stringify(OUTCOME_TRANSITION_COUNTER)),
                                                "0": JSON.parse(JSON.stringify(OUTCOME_TRANSITION_COUNTER))}
};
