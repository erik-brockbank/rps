...
const ADAPTIVE_BOT_STRATEGY_SET = [ // set of available adaptive strategies
    "opponent_prev_moves", // maximize against the opponent's move distribution
    // "opponent_prev_transitions", // maximize against the opponent's transition distribution (relative to their own move)
